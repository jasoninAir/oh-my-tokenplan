...
一个 60 行的 mini Python 库，演示 multiagent 协议的完整状态机路径。

## 怎么读这个示例

1. 从 `docs/agents/stories/` 开始，按 S-001 → S-002 → S-003 → S-004 顺序读
2. 对照 `docs/agents/reviews/` 看每一轮的反馈
3. 跑 `bin/agents check --strict` 验证示例数据完整
